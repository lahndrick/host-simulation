...
#  opp_makemake -f --deep -O out -KINET4_5_PROJ=C:/omnetpp-6.0.1/samples/inet4.5 -DINET_IMPORT -I. -I$$\(INET4_5_PROJ\)/src -L$$\(INET4_5_PROJ\)/src -lINET$$\(D\)
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = assignment$(D)
...
INET4_5_PROJ=C:/omnetpp-6.0.1/samples/inet4.5
